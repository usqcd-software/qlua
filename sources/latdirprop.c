...
q_P_get(lua_State *L)
{
    ...
    case qTable: {
        ...
        QDP_D_eq_diracvec_P(r->ptr, V->ptr, c, d, QDP_all);
...
q_P_gaussian(lua_State *L)
{
    ...
    QDP_P_eq_gaussian_S(r->ptr, a->ptr, QDP_all);
...
q_P_norm2(lua_State *L)
{
    ...
    QDP_r_eq_norm2_P(&n, a->ptr, QDP_all);
    lua_pushnumber(L, n);
...
q_P_shift(lua_State *L)
{
    ...
    QDP_P_eq_sP(r->ptr, a->ptr, shift, dir, QDP_all);
...
q_P_conj(lua_State *L)
{
    ...
    QDP_P_eq_conj_P(r->ptr, a->ptr, QDP_all);
...
q_P_trans(lua_State *L)
{
    ...
    QDP_P_eq_transpose_P(r->ptr, a->ptr, QDP_all);
...
q_P_adjoin(lua_State *L)
{
    ...
    QDP_P_eq_Pa(r->ptr, a->ptr, QDP_all);
...
q_P_spintrace(lua_State *L)
{
    ...
    QDP_M_eq_spintrace_P(r->ptr, a->ptr, QDP_all);
...
q_P_add_P(lua_State *L)
{
    ...
    QDP_P_eq_P_plus_P(c->ptr, a->ptr, b->ptr, QDP_all);
...
q_P_sub_P(lua_State *L)
{
    ...
    QDP_P_eq_P_minus_P(c->ptr, a->ptr, b->ptr, QDP_all);
...
q_P_mul_r(lua_State *L)
{
    ...
    QDP_P_eq_r_times_P(c->ptr, &b, a->ptr, QDP_all);
...
q_r_mul_P(lua_State *L)
{
    ...
    QDP_P_eq_r_times_P(c->ptr, &a, b->ptr, QDP_all);
...
q_P_mul_c(lua_State *L)
{
    ...
    QDP_P_eq_c_times_P(c->ptr, b, a->ptr, QDP_all);
...
q_c_mul_P(lua_State *L)
{
    ...
    QDP_P_eq_c_times_P(c->ptr, a, b->ptr, QDP_all);
...
q_P_neg(lua_State *L)
{
    ...
    QDP_P_eq_r_times_P(r->ptr, &m1, a->ptr, QDP_all);
...
q_P_mul_P(lua_State *L)
{
    ...
    QDP_P_eq_P_times_P(c->ptr, a->ptr, b->ptr, QDP_all);
...
q_P_mul_M(lua_State *L)
{
    ...
    QDP_P_eq_P_times_M(c->ptr, a->ptr, b->ptr, QDP_all);
...
q_M_mul_P(lua_State *L)
{
    ...
    QDP_P_eq_M_times_P(c->ptr, a->ptr, b->ptr, QDP_all);
...
q_P_div_c(lua_State *L)
{
    ...
    QDP_P_eq_c_times_P(c->ptr, &s, a->ptr, QDP_all);
...
q_P_dot(lua_State *L)
{
    ...
    QDP_C_eq_P_dot_P(s->ptr, a->ptr, b->ptr, QDP_all);
...
q_latdirprop(lua_State *L)
{
    ...
    case 1: {
        ...
        QDP_P_eq_P(v->ptr, w->ptr, QDP_all);
    ...
    case 2: {
        ...
        QDP_P_eq_zero(v->ptr, QDP_all);
        QDP_P_eq_diracvec_D(v->ptr, z->ptr, c, d, QDP_all);
